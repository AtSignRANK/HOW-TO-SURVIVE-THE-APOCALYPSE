...
# Plugins
$Plugins = (
    "https://github.com/AtSignRANK/HOW-TO-SURVIVE-THE-APOCALYPSE/releases/download/1.0/APOCALYPSE.jar"
)
...
Function Backup
{
    ...
    & 'C:\Program Files\7-Zip\7z.exe' a -tzip $ArchiveName ./ "-xr!*.gz" "-x!paper.jar" "-x!paper.ps1" "-x!backup" "-x!cache" | Out-Null
...
#    }
    ...
    $Restart = Choice "Restart? [Y]es [N]o" @('Y', 'N') 'N' 5
